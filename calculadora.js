...
const mostrarValor = () => {
    ...
    const input1 = document.getElementsById("valor1")
    
    let valor1 = input1.value
    console.log(valor1)
    console.log("mostrando valor")

    const span = document.getElementsById("input-valor")
    console.log(span)
    console.log (span.innerHTML)
    span.innerHTML = valor1.value
}
//----------calculadora----------

// leer inputs debe leer dos inputs, validarlos 
